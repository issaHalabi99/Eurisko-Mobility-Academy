...
export const add_Films = () => {
  return (dispatch) => {
    Promise
      .all([
        axios.get(
          "/tv?api_key=224ce27b38a3805ecf6f6c36eb3ba9d0&with_genres=28"
        ),
        axios.get(
          "/tv?api_key=224ce27b38a3805ecf6f6c36eb3ba9d0&with_genres=35"
        ),
        axios.get(
          "/tv?api_key=224ce27b38a3805ecf6f6c36eb3ba9d0&with_genres=80"
        ),
      ])
      .then((res) => {
